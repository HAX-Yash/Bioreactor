...
const System1: React.FC = (syncState) => {
    ...
    useEffect(() => {
        const fetchIndicators = async () => {
            try {
                const response = await axios.get('http://localhost:3001/get_ESP_data_1');
    ...
    return (
        <div className="w-100% max-w-4xl mx-auto bg-gray-100 p-4 rounded-lg shadow-md flex flex-col space-y-6">
            <Typography variant="h6" className="text-2xl font-semibold text-gray-800 mb-4 text-center">System 1 (25L Bioreactor)</Typography>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md flex flex-col md:flex-row gap-8">
                <div className="flex-1 flex flex-col items-center space-y-4">
                    ...
                    <ToggleButton
                        label="Motor ON / OFF"
                        postEndpoint="http://localhost:3001/post_dashboard_data_1"
                        system="System1"
                        stateKey="motorState"
                ...
                <div className="flex-1 flex flex-col items-center space-y-4">
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-md">
                        <GaugeChartComponent
                            ...
                            max={4000}
                            system="System1"
                            endpoint='http://localhost:3001/get_ESP_data_1'
                        />
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <TempGraph system="System1" yAxisMin={0} yAxisMax={100} endpoint='http://localhost:3001/get_ESP_data_1' />
            ...
            <ValueDialog
                ...
                endpoint='http://localhost:3001/post_dashboard_data_1'
