...
const System2: React.FC = () => {
    ...
    useEffect(() => {
        const fetchIndicators = async () => {
            try {
                const response = await axios.get('http://localhost:3001/get_ESP_data_2');
    ...
    return (
        <div className="w-full max-w-4xl mx-auto bg-gray-100 dark:bg-gray-100 p-4 rounded-lg shadow-md flex flex-col space-y-6">
            <Typography variant="h6" className="text-2xl font-semibold text-gray-800 dark:text-gray-800 mb-4 text-center">System 2 (25L Bioreactor)</Typography>
            <Typography variant="h6" className="text-xl font-semibold text-gray-800 dark:text-gray-800 mb-4 text-center">Indicators</Typography>
            ...
            <div className="bg-white dark:bg-white p-8 rounded-lg shadow-md flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-1 flex flex-col items-center space-y-4">
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-md">
                        <GaugeChartComponent
                            ...
                            max={4000}
                            system="System2"
                            endpoint="http://localhost:3001/get_ESP_data_2"
                        />
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
                ...
                <div className="bg-white dark:bg-gray-100 p-5 rounded-md shadow-md">
                    <Typography variant="h6" className="text-xl font-semibold text-gray-800 dark:text-gray-800 mb-4 text-center">Temperature</Typography>
                    <TextField
                        label="Temperature"
                        value={heaterTemp2}
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <TempGraph system="System2" yAxisMin={0} yAxisMax={100} endpoint='http://localhost:3001/get_ESP_data_2' />
            ...
            <ValueDialog
                ...
                endpoint='http://localhost:3001/post_dashboard_data_2'
