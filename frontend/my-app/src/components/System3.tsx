...
const System3: React.FC = (syncState) => {
    ...
    useEffect(() => {
        const fetchIndicators = async () => {
            try {
                const response = await axios.get('http://localhost:3001/get_ESP_data_3');
                const data = response.data;
                // Set indicators for System3
                setIndicators(data.System3 || {});
            } catch (error) {
    ...
    return (
        <div className="w-100% max-w-4xl mx-auto bg-gray-100 p-4 rounded-lg shadow-md flex flex-col space-y-6">
            <Typography variant="h6" className="text-2xl font-semibold text-gray-800 mb-4 text-center">System 3 Controls (10L Bioreactor)</Typography>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                    <Indicator label="Manual mode" isActive={indicators['System3.MANUAL_CONTROL_INDICATOR'] ?? false} />
                    <Indicator label="Acid Pump" isActive={indicators['System3.ACID_PUMP'] ?? false} />
                    <Indicator label="Base Pump" isActive={indicators['System3.BASE_PUMP'] ?? false} />
                    <Indicator label="Oxygen Valve" isActive={indicators['System3.OXYGEN_VALVE'] ?? false} />
                    <Indicator label="Nitrogen Valve" isActive={indicators['System3.NITROGEN_VALVE'] ?? false} />
                    <Indicator label="Heater" isActive={indicators['System3.TEMP_RELAY'] ?? false} />
                </div>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-md flex flex-col md:flex-row gap-8">
                <div className="flex-1 flex flex-col items-center space-y-4">
                    ...
                    <ToggleButton
                        label="Motor ON / OFF"
                        postEndpoint="http://localhost:3001/post_dashboard_data_3"
                        system="System3"
                        stateKey="motorState"
                ...
                <div className="flex-1 flex flex-col items-center space-y-4">
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-md">
                        <GaugeChartComponent
                            ...
                            max={4000}
                            system="System3"
                            endpoint='http://localhost:3001/get_ESP_data_3'
                        />
                    </div>
                </div>
            </div>
            ...
            <Typography variant="h6" className="text-2xl font-semibold text-gray-800 mb-4 text-center">Set Values for 10L Bioreactor</Typography>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <TempGraph system="System3" yAxisMin={0} yAxisMax={100} endpoint='http://localhost:3001/get_ESP_data_3' />
            ...
            <ValueDialog
                ...
                endpoint='http://localhost:3001/post_dashboard_data_3'
